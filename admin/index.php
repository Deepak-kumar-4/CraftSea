...
<head>
      <meta charset="utf-8">
      <title>CRFATSEA ADMIN - Dashboard</title>
                  ...
                  <div class="navbar-nav w-100">
                        ...
                        <div class="nav-item dropdown">
                              ...
                              <div class="dropdown-menu bg-transparent border-0">
                                    <a href="sales-report.php" class="dropdown-item"><i
                                          class="fa fa-chart-line me-2"></i>&nbsp;Sales Reports</a>
                              </div>
                        </div>
                        ...
                        <div class="nav-item dropdown">
                              <a href="order.php" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
            ...
            <div class="content">
                  ...
                  <!-- Navbar End -->
                    ...
                    <?php
                        $totle_order=0;
                        $todays_order=0;
                        $count=mysqli_query($con,"SELECT * FROM customer");
                        $reguser=mysqli_num_rows($count);
                        $total_revenu=0;
                        $todays_revenu=0;
                        $totle_profit=0;
                        $todays_profit=0;
                        ...
                        while($row = mysqli_fetch_assoc($result))
                            {
                                ...
                                $totle_profit+=($row['price']*25/100)*$row['quantity'];
                                ?><script>//alert("<?php echo date('m',strtotime(date('y-m-d').'+10 days'));?>");</script><?php
                                if(strtotime(date('y-m-d').'-30 days')==strtotime($row['order_date']))
                                {
                                    $todays_order++;
                                    $todays_revenu+=$row['price']*$row['quantity']+49;
                                    $todays_profit+=($row['price']*25/100)*$row['quantity'];
                                }
                        ...
                        <div class="row g-4">
                              <div class="col-sm-6 col-xl-4">
                                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                                          <i class="fa fa-chart-bar fa-6x text-primary"></i>
                                          <div class="ms-3">
                                                <p class="mb-2">Total Orders</p>
                                                <h6 class="mb-0"><?php echo $totle_order;?></h6>
                                          </div>
                                    </div>
                              </div>
                              <div class="col-sm-6 col-xl-4">
                                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                                          <i class="fa fa-chart-line fa-6x text-primary"></i>
                                          <div class="ms-3">
                                                <p class="mb-2">New Orders</p>
                                                <h6 class="mb-0"><?php echo $todays_order;?></h6>
                                          </div>
                                    </div>
                              </div>
                              <div class="col-sm-6 col-xl-4">
                                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                                          <i class="fa fa-th me-2 fa-6x text-primary"></i>
                                          <div class="ms-3">
                                                <p class="mb-2">Registered Users</p>
                                                <h6 class="mb-0"><?php echo $reguser;?></h6>
                                          </div>
                                    </div>
                              </div>
                              <div class="col-sm-6 col-xl-4">
                                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                                          ...
                                          <div class="ms-3">
                                                ...
                                                <h6 class="mb-0">₹<?php echo $todays_profit;?></h6>
                                          </div>
                                    </div>
                              </div>
                              <div class="col-sm-6 col-xl-4">
                                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                                          ...
                                          <div class="ms-3">
                                                ...
                                                <h6 class="mb-0">₹<?php echo $totle_profit;?></h6>
                                          </div>
                                    </div>
                              </div>
                              <div class="col-sm-6 col-xl-4">
                                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                                          <i class="fa fa-chart-area fa-6x text-primary"></i>
                                          <div class="ms-3">
                              ...
                              <div class="col-sm-6 col-xl-4">
                                    <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                                          <i class="fa fa-chart-pie fa-6x text-primary"></i>
                                          <div class="ms-3">
