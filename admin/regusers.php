...
<head>
      <meta charset="utf-8">
      <title>Craftsea ADMIN - Users</title>
      ...
      <div class="container-fluid position-relative bg-white d-flex p-0">
            ...
            <div class="sidebar pe-4 pb-3">
                  <nav class="navbar bg-light navbar-light">
                        ...
                        <div class="navbar-nav w-100">
                              ...
                              <a href="regusers.php" class="nav-item nav-link active"><i class="fa fa-th me-2"></i>Regd
                                    Users</a>
            ...
            <div class="content">
                  ...
                  <div class="container-fluid pt-4 px-4">
                        <h2 style="color:#FF6F61  ;"><center>Craftsea - Registered Users List</center></h2>
                        <br>
                        <div class="row g-4">
                              <div class="col-sm-12 col-xl-12">
                                    <div class="bg-light rounded h-100 p-4">
                                          <h4 class="mb-4"><center>Users Details</center></h4>
                                          <table class="table table-responsive">
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        $getdata=mysqli_query($con,"SELECT * FROM customer");
