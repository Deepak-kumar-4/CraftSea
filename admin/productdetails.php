            ...
            <div class="content">
                  ...
                  <div class="container-fluid pt-4 px-4">
                        <h2 style="color:#FF6F61  ;">
                              <center>Craftsea - Product Details by Category or Brand</center>
                        </h2>
                        <br>
                        <div class="row g-4">
                              <div class="col-sm-12 col-xl-12">
                                    <div class="bg-light rounded h-100 p-4">
                                          ...
                                          <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <?php
                                                        $getdata=mysqli_query($con,"SELECT * FROM product");
                                                    ...
                                                    ?>
                                                      ...
                                                      <!-- <tr>
                                                            ...
                                                            <td>Oxidised Rings</td>
                                                            <td>Necklaces</td>
                                                            <td>Oxidisation process creates a light and shadow etc...
                                                            </td>
                                                            <td>599</td>
                                                            <td>Oxidised Rings</td>
                                                      </tr>
