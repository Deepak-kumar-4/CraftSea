            ...
            <div class="sidebar pe-4 pb-3">
                  <nav class="navbar bg-light navbar-light">
                        ...
                        <div class="navbar-nav w-100">
                              ...
                              <div class="nav-item dropdown">
                                    <a href="order.html" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i
                                                class="far fa-file-alt me-2"></i>Orders</a>
                                    <div class="dropdown-menu bg-transparent border-0">
                                          <a href="order.php" class="dropdown-item">Order Status</a>
                                    </div>
                              </div>
                              <a href="shipaddress.html" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Address</a>
                        </div>
                  </nav>
            </div>
            <!-- Sidebar End -->
                              ...
                              <div class="bg-light rounded h-100 p-4">
                                    ...
                                    <form method="get" action="addproducts.php">
                                          <!-- <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                      <input type="number" class="form-control" name="" id="inputEmail3">
                                                </div>
                                          </div> -->
                                          <div class="row mb-3">
                                          ...
                                          <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                      <!-- <input type="text" class="form-control" id="description" name="description"> -->
                                                      <textarea name="specification" id="specification" class="form-control" cols="30" rows="5"></textarea>
                                                </div>
                                          </div>
                                          <div class="row mb-3">
                                          ...
                                          <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                      <input type="text" class="form-control" id="buildtype" name="buildtype">
                                                </div>
                                          </div>
                                          <div class="row mb-3">
                                                <label for="formFile1" class="col-sm-2 col-form-label">Product Image 1</label>
                                                <div class="col-sm-10">
                                                      <input class="form-control" name="image1" type="file" accept="image/png, image/jpg, image/jpeg" id="formFile1">
                                                </div>
                                          </div>
                                          <div class="row mb-3">
                                                <label for="formFile2" class="col-sm-2 col-form-label">Product Image 2</label>
                                                <div class="col-sm-10">
                                                      <input class="form-control" name="image2" type="file" accept="image/png, image/jpg, image/jpeg" id="formFile2">
                                                </div>
                                          </div>
                                          <div class="row mb-3">
                                                <label for="formFile3" class="col-sm-2 col-form-label">Product Image 3</label>
                                                <div class="col-sm-10">
                                                      <input class="form-control" name="image3" type="file" accept="image/png, image/jpg, image/jpeg" id="formFile3">
                                                </div>
                                          </div>
                                          <br>
                                          <center>
