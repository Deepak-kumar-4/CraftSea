...
<head>
      <meta charset="utf-8">
      <title>Craftsea ADMIN - User Address</title>
            ...
            <div class="sidebar pe-4 pb-3">
                  <nav class="navbar bg-light navbar-light">
                        ...
                        <div class="navbar-nav w-100">
                              ...
                              <a href="shipaddress.php" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Address</a>
                        </div>
                  </nav>
            </div>
            <!-- Sidebar End -->
            ...
            <div class="content">
                  ...
                  <div class="container-fluid pt-4 px-4">
                        <h2 style="color:#FF6F61  ;">
                              <center>Craftsea - Shipping Address</center>
                        </h2>
                        <br>
                        <div class="row g-4">
                                          ...
                                          <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <?php
                                                        ...
                                                        $getdata=mysqli_query($con,"SELECT * FROM orders");
                                                    ...
                                                    ?>
                                                      ...
                                                      <tr>
                                                            ...
                                                            <td>1234567890</td>
                                                            <td>#1/82 Hello Street Jayanagar</td>
                                                            <td>India</td>
                                                            <td>Bangalore</td>
                                                            <td>Karnataka</td>
                                                            <td>560012</td>
